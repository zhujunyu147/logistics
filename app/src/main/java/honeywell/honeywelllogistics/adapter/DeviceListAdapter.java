package honeywell.honeywelllogistics.adapter;
...
import honeywell.honeywelllogistics.activity.ScanDeviceActivity;
...
//                intent.setClass(mContext, ScanDeviceActivity.class);
//                intent.putExtra("mac", result.getAddress());
//                mContext.startActivity(intent);
                mClickCallback.onclick(result);
            }
        });
